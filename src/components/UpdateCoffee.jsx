...
const UpdateCoffee = () => {
  ...
  const handleUpdateCoffee = (event) => {
    ...
    const updateCoffee = { name, quantity, supplier, taste, category, details, price, voucher, photoURL };
  ...
  return (
    <div className="bg-[#F4F3F0] py-10 md:px-24">
      <div className="bg-red-300 flex justify-between p-5 mb-10">
        <h1 className="text-3xl text-purple-600 text-center font-semibold">Update {name}</h1>
        <div>
          <Link to="/">
